...
module.exports = function (flights) {
    ...
    functions.email = function(req, res){
        var content = JSON.parse(req.body.mandrill_events)[0],
        event = content.event, //should be inbound
        from = content.msg.from_email,
        from_name = content.msg.from_name,
        date = content.msg.headers.Date,
